import vector565 from "../assets/figma/vector-565.svg";
    ...
    <div ref={parallaxRef} className="relative">
      <FigmaFrame width={1440} height={1024} className="bg-[#0e111e]">
        ...
        <RevealOnScroll
          ...
          rel="noreferrer"
          immediate
          className="absolute left-[100px] top-[707px] flex items-center justify-center transition hover:opacity-80"
          style={{ animationDelay: "0s" }}
        >
          <p className="font-urbanist text-[16px] font-medium whitespace-nowrap text-white">
            Book a call with us
          </p>
        </RevealOnScroll>
        ...
        <img
          src={vector565}
          alt=""
          className="absolute left-[98px] top-[788px] w-[649.5px]"
        />

        <RevealOnScroll
          as="p"
          immediate
          className="absolute left-[91px] top-[809px] font-manrope text-[80px] font-medium leading-[normal] whitespace-nowrap text-white"
          style={{ animationDelay: "0.06s" }}
        >
          Designing for Better <RotatingWord words={HERO_ROTATING_WORDS} />
        </RevealOnScroll>
